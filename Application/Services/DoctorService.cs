...
namespace Application.Services
{
    public class DoctorService : IDoctorService
    {
        ...
        public async Task<DoctorReadDto> UpdateAsync(int id, DoctorUpdateDto dto)
        {
            ...
            entity.UpdateProfile(dto.DepartmentId,dto.Name,dto.DateOfBirth ,dto.Specialization, dto.Gender, dto.Email, dto.MobileNumber, dto.Address , dto.City, dto.Country, dto.PostalCode );
