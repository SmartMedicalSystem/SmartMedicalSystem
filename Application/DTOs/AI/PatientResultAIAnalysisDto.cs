...
namespace Application.DTOs.AI
{
    ...
    public class PatientResultAIAnalysisDto
    {
        ...
        /// <summary>
        /// When the AI analysis / summary object was generated by the system.
        /// </summary>
        public DateTime GeneratedAtUtc { get; set; }

        /// <summary>
        /// The date the underlying lab test / session was performed.
        /// Included so full patient reports can show the test date next to each lab result.
        /// </summary>
